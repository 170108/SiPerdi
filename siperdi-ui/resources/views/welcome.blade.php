...
<body>
  ...
  <main>
    <section class="hero" data-student-hidden data-admin-hidden>
    ...
    <section id="fitur" class="section" data-admin-hidden>
      <div class="section-title">
        <h2>Fitur Utama SiPerdi</h2>
        <p>Dirancang untuk proses peminjaman buku fisik yang tertib dan terdata.</p>
      </div>
      <div class="features">
        <a class="feature feature-link" href="#auth-modal" data-open-auth="signup-student">
    ...
    <section id="alur" class="section flow" data-admin-hidden>
      <div class="section-title">
      ...
      <div class="flow-grid">
        <div class="flow-step">
          ...
          <p>Registrasi menggunakan NIS, kelas, dan email sekolah.</p>
        </div>
        <div class="flow-step">
        ...
        <section id="profile-siswa" class="section profile profile-student" data-requires-auth data-admin-hidden data-auth-only>
      <div class="section-title">
        <h2>Profil Siswa</h2>
        <p>Kelola identitas, pantau ringkasan peminjaman, dan atur tema favoritmu.</p>
      </div>
      <div class="lockable profile-stack">
        <div class="card profile-card profile-social">
          ...
          <div class="profile-header">
            <div class="profile-avatar">
              ...
              <p class="sub">Format JPG/PNG, max 2MB.</p>
            </div>
            <div class="profile-meta">
              ...
              <div class="profile-badges">
                ...
                <span class="badge">SMK N 1 Cikarang Selatan</span>
              </div>
            </div>
          </div>
          <div class="profile-actions">
            <button class="btn solid small" type="button" data-open-loan>Pinjam Buku</button>
            <button class="btn outline small" type="button" data-scroll-target="#dashboard">Lihat Dashboard</button>
            <button class="btn ghost small" type="button" data-scroll-target="#pembayaran">Pembayaran Denda</button>
          </div>
          <div class="profile-stats">
            <div>
              <span>Total Peminjaman</span>
              <strong data-profile-stat="total">0</strong>
            </div>
            <div>
              <span>Jatuh Tempo</span>
              <strong data-profile-stat="due">0</strong>
            </div>
            <div>
              <span>Denda</span>
              <strong data-profile-stat="fine">Rp 0</strong>
            </div>
          </div>
        ...
        <div class="card profile-preferences" data-admin-hidden>
          <h3>Tema Tampilan</h3>
          <p class="sub">Pilih tema yang paling nyaman untuk belajar.</p>
          <div class="theme-toggle">
            <button class="theme-option" type="button" data-theme-option="default">Default</button>
            <button class="theme-option" type="button" data-theme-option="light">Terang</button>
            <button class="theme-option" type="button" data-theme-option="dark">Gelap</button>
          </div>
          <p class="sub" data-theme-status>Tema aktif: Default.</p>
        </div>
      </div>
      <div class="guard">
        <p>Silakan login atau sign up untuk melihat profil siswa.</p>
        <button class="btn solid" data-open-auth="signup-student">Masuk / Daftar</button>
      </div>
    </section>
    ...
    <section id="profile-admin" class="section profile profile-admin" data-requires-auth data-auth-only>
      ...
      <div class="lockable">
        <div class="card profile-card profile-social admin-profile-card">
          <div class="profile-cover"></div>
          <div class="profile-header">
            <div class="profile-avatar">
              <img src="{{ asset('img/avatar.svg') }}" alt="Foto Admin" data-profile-photo />
              <span class="badge danger">Admin</span>
            </div>
            <div class="profile-meta">
              <h3 data-profile="name">-</h3>
              <p class="sub">Administrator Perpustakaan</p>
              <div class="profile-badges">
                <span class="badge neutral">Akses Penuh</span>
                <span class="badge">SiPerdi Control</span>
              </div>
            </div>
          </div>
          <div class="profile-details">
            <div><span>Email</span><strong data-profile="email">-</strong></div>
            <div><span>Role</span><strong data-profile="role">Admin</strong></div>
            <div><span>Hak Akses</span><strong>Kelola seluruh data siswa &amp; peminjaman</strong></div>
          </div>
          <div class="form-message" data-message="profile"></div>
        </div>
      </div>
    ...
    @endif
      ...
      <div class="section-title">
        ...
        <p>Ajukan peminjaman buku fisik melalui tombol Pinjam Buku.</p>
      ...
      <div class="lockable">
        <div class="loan-grid">
          <div class="card">
            ...
            <div class="form-message" data-message="loan-list"></div>
          </div>
        </div>
      </div>
      <div class="guard">
    ...
    <section class="section operational" data-student-hidden data-admin-hidden>
      <div class="section-title">
      ...
      <div class="dashboard-grid">
        ...
        <section id="katalog" class="section catalog" data-admin-hidden>
      <div class="section-title">
        <h2>Katalog Buku Fisik</h2>
        <p>Daftar buku pelajaran per jurusan dan buku umum yang tersedia.</p>
      </div>
      <div class="catalog-search">
        <div class="form">
          <label for="catalog-search">Cari Buku</label>
          <input id="catalog-search" type="text" placeholder="Ketik judul buku..." data-catalog-search />
        </div>
        <p class="sub" data-catalog-count>Menampilkan semua buku.</p>
        <div class="empty-state" data-catalog-empty>Tidak ada buku yang cocok.</div>
      </div>
      <div class="catalog-block">
        ...
        <div class="catalog-grid">
          <div class="card catalog-card">
            <span class="catalog-tag">TJKT</span>
    ...
    <section id="dashboard" class="section dashboard" data-admin-hidden>
      <div class="section-title">
    ...
    <section id="admin-dashboard" class="section admin hidden" data-admin-only>
      <div class="section-title">
        ...
        <p>Kelola data siswa, peminjaman, dan persetujuan pengembalian buku.</p>
      </div>
      <div class="admin-actions">
        <button class="btn outline" data-admin-download>Unduh Laporan CSV</button>
      </div>
      <div class="dashboard-grid admin-summary">
        <div class="card">
          <h3>Data Siswa</h3>
          <ul class="list">
            <li><span>Total siswa</span><strong data-admin-students>0</strong></li>
          </ul>
          <p class="sub">Sumber dari akun yang telah sign up.</p>
        </div>
        <div class="card">
        ...
        <div class="card">
          ...
          <p class="sub">Dihitung otomatis dari keterlambatan.</p>
        </div>
      </div>
            <div class="dashboard-grid admin-data">
        <div class="card">
          <h3>Daftar Siswa Terdaftar</h3>
          <div class="table mini admin-students-table">
            <div class="table-head">
              <span>Nama</span>
              <span>NIS</span>
              <span>Kelas</span>
            ...
            <div class="table-body" data-admin-students-list></div>
          </div>
          <div class="empty-state show" data-admin-students-empty>Belum ada siswa terdaftar.</div>
        </div>
        <div class="card">
          <h3>Data Peminjaman Siswa</h3>
          <div class="table mini admin-loans-table">
            <div class="table-head">
              <span>Siswa</span>
              <span>Judul</span>
              <span>Pinjam</span>
            ...
            <div class="table-body" data-admin-loans-list></div>
          </div>
          <div class="empty-state show" data-admin-loans-empty>Belum ada peminjaman.</div>
        </div>
        <div class="card">
          <h3>Status Jatuh Tempo &amp; Denda</h3>
          <div class="table mini admin-fines-table">
            <div class="table-head">
              <span>Nama</span>
              <span>NIS</span>
              <span>Jatuh Tempo</span>
            ...
            <div class="table-body" data-admin-fines-list></div>
          </div>
          <div class="empty-state show" data-admin-fines-empty>Belum ada data denda.</div>
        </div>
      </div>
      <div class="card admin-catalog">
        <h3>Katalog Buku (Admin)</h3>
        <p class="sub">Ringkasan stok buku yang dapat dipinjam siswa.</p>
        <div class="table mini admin-catalog-table">
          <div class="table-head">
            <span>Kode</span>
            <span>Judul</span>
            <span>Kategori</span>
          ...
          <div class="table-row">
            <span>001/B/CIKSEL/2026</span>
            <span>Algoritma dan Pemrograman</span>
            <span>Teknologi</span>
            <span>8</span>
            <span class="badge success">Tersedia</span>
          </div>
          <div class="table-row">
            <span>002/B/CIKSEL/2026</span>
            <span>Basis Data Dasar</span>
            <span>Teknologi</span>
            <span>4</span>
            <span class="badge warn">Terbatas</span>
          </div>
          <div class="table-row">
            <span>003/B/CIKSEL/2026</span>
            <span>Jaringan Komputer Dasar</span>
            <span>TKJ</span>
            <span>6</span>
            <span class="badge success">Tersedia</span>
          </div>
          <div class="table-row">
            <span>004/B/CIKSEL/2026</span>
            <span>Akuntansi Dasar</span>
            <span>AKL</span>
            <span>3</span>
            <span class="badge warn">Terbatas</span>
          </div>
          <div class="table-row">
            <span>005/B/CIKSEL/2026</span>
            <span>Laskar Pelangi</span>
            <span>Literasi</span>
            <span>6</span>
            <span class="badge success">Tersedia</span>
    ...
    <section class="section library-history" id="sejarah" data-student-hidden data-admin-hidden>
      <div class="section-title">
    ...
    <section id="pembayaran" class="section payment" data-requires-auth data-auth-only data-admin-hidden>
      <div class="section-title">
    ...
    <section id="kontak" class="section contact" data-student-hidden data-admin-hidden>
      <div class="section-title">
  ...
  <footer class="footer">
    ...
    <div class="footer-links">
      ...
      <a href="#alur" data-admin-hidden>Alur</a>
      <a href="#katalog" data-admin-hidden>Katalog</a>
      <a href="#dashboard" data-admin-hidden>Dashboard</a>
    </div>
  </footer>
    ...
    <div class="modal-card">
      ...
      <div class="auth-panel" data-auth-panel="login">
        ...
        <form class="form" data-form="login">
          ...
          <label data-login-label>NIS</label>
          <input type="text" name="email" placeholder="123456" required data-login-input inputmode="numeric" />
        ...
        <p class="switch">
          Belum verifikasi?
          <button type="button" class="link" data-auth-switch="verify">Verifikasi Email</button>
        </p>
      </div>
      ...
      <div class="auth-panel hidden" data-auth-panel="verify">
        <h3>Verifikasi Email</h3>
        <p class="sub">Masukkan kode verifikasi yang dikirim ke email.</p>
        <form class="form" data-form="verify">
          <label>Email</label>
          <input type="email" name="email" placeholder="nama@sekolah.id" required />
          <label>Kode Verifikasi</label>
          <input type="text" name="code" placeholder="6 digit kode" required />
          <div class="form-message" data-message="verify"></div>
          <button class="btn solid full">Verifikasi</button>
        </form>
        <p class="switch">
          Kembali ke login?
          <button type="button" class="link" data-auth-switch="login">Login</button>
  ...
  <div class="modal" id="loan-modal" aria-hidden="true">
    <div class="modal-backdrop" data-close-loan></div>
    <div class="modal-card loan-modal">
      <button class="close" data-close-loan>&times;</button>
      <h3>Form Peminjaman</h3>
      <p class="sub">Isi data peminjaman buku fisik agar tercatat otomatis oleh admin perpustakaan.</p>
  ...
  <button class="fab" type="button" data-open-loan data-admin-hidden>Pinjam Buku</button>
